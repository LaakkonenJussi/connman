...
static const char *wifi_bss_enc_mode(GSupplicantBSS *bss)
{
	...
	case CONNMAN_SERVICE_SECURITY_8021X:
		...
		if (((pairwise & GSUPPLICANT_CIPHER_CCMP) ||
				(pairwise & GSUPPLICANT_CIPHER_CCMP_256)) &&
			...
			return "tkip";
		} else if ((pairwise & GSUPPLICANT_CIPHER_GCMP) ||
				(pairwise & GSUPPLICANT_CIPHER_GCMP_256)) {
			return "gcmp";
		}
...
static struct wifi_plugin *wifi_plugin_new(void)
{
	...
	const char *wpa3_support_str = connman_setting_get_string(
							"WifiWPA3Support");
